...
* **Pensamiento Crítico** y atención al detalle para identificar defectos.
* **Comunicación Efectiva** y **Trabajo en Equipo** en entornos ágiles.
* Conocimientos técnicos en **Python** y **JavaScript**.

### Habilidades Clave en QA
...
## 💼 Proyectos Destacados (QA)

En esta sección, podrás encontrar ejemplos concretos de mi trabajo en aseguramiento de la calidad. Cada enlace te llevará a la documentación completa del proyecto (Plan de Pruebas, Casos, Evidencia y Reporte de Bugs).

| Proyecto | Tipo de Testing | Enlace a la Aplicación | Documentación Completa |
| :--- | :--- | :--- | :--- |
...
* **Whatsapp:** (https://wa.me/5491176280738)
